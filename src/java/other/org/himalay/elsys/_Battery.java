...
public class _Battery extends ElsysDataFactory.ElsysData { // Concrete type is Battery
	...
	public _Battery() // throws Exception
	{
		init();
	}
	...
	public int dump(DumpContext dc) throws IOException {
		...
		// write _value
		dc.indent();
		dc.getPs().println("_value=" + value + "(0x" + Integer.toHexString(value) + ")");
		// write time
		dc.indent();
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x07);
	}
