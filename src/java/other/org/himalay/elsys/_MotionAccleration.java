...
public class _MotionAccleration extends ElsysDataFactory.ElsysData { // Concrete type is MotionAccleration
	...
	public _MotionAccleration() // throws Exception
	{
		init();
	}
	...
	public int dump(DumpContext dc) throws IOException {
		dc.indent();
		dc.getPs().print("_MotionAccleration\n");
		dc.increaseIndent();
		int retVal = 0;
		// write header
		if (header != null) {
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x0f);
	}
