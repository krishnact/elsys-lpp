...
public class _PulseCountABS extends ElsysDataFactory.ElsysData { // Concrete type is PulseCountABS
	...
	public _PulseCountABS() // throws Exception
	{
		init();
	}
	...
	public int readNoHeader(DataInputStream istream) throws IOException {
		...
		// read value
		{
			value = (long) (BinPrimitive.readUI32(istream));
			retVal += 4;
		}
		// read time
		{
	...
	public int write(DataOutputStream ostream) throws IOException {
		...
		// write value
		BinPrimitive.writeUI32(ostream, value);
		retVal += 4;
		// write time
		{
	...
	public int dump(DumpContext dc) throws IOException {
		...
		// write value
		dc.indent();
		dc.getPs().println("value=" + value + "(0x" + Long.toHexString(value) + ")");
		// write time
		dc.indent();
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x0b);
	}
