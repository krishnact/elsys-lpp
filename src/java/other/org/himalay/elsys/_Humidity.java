...
public class _Humidity extends ElsysDataFactory.ElsysData { // Concrete type is Humidity
	...
	public _Humidity() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x02);
	}
