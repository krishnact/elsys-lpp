...
public class _Occupancy extends ElsysDataFactory.ElsysData { // Concrete type is Occupancy
	...
	public _Occupancy() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x11);
	}
