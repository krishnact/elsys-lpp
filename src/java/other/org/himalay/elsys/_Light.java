...
public class _Light extends ElsysDataFactory.ElsysData { // Concrete type is Light
	...
	public _Light() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x04);
	}
