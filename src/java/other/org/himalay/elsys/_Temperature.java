...
public class _Temperature extends ElsysDataFactory.ElsysData { // Concrete type is Temperature
	...
	public _Temperature() // throws Exception
	{
		init();
	}
