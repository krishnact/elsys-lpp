...
public class _Analog1 extends ElsysDataFactory.ElsysData { // Concrete type is Analog1
	...
	public _Analog1() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x08);
	}
