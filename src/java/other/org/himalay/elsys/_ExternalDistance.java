...
public class _ExternalDistance extends ElsysDataFactory.ElsysData { // Concrete type is ExternalDistance
	...
	public _ExternalDistance() // throws Exception
	{
		init();
	}
	...
	public int dump(DumpContext dc) throws IOException {
		dc.indent();
		dc.getPs().print("_ExternalDistance\n");
		dc.increaseIndent();
		int retVal = 0;
		// write header
		if (header != null) {
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x0e);
	}
