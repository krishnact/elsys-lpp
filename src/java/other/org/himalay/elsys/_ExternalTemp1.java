...
public class _ExternalTemp1 extends ElsysDataFactory.ElsysData { // Concrete type is ExternalTemp1
	...
	public _ExternalTemp1() // throws Exception
	{
		init();
	}
	...
	public void setHeader(LPPHeader header) {
		this.header = header;
		this.header.setMessageType(0x0c);
	}
